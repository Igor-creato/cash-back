        ...
        return array(
            ...
            'pd_policy' => array(
                ...
                array(
                    ...
                    array( '{{operator_full_name}}', 'Должен сохраняться плейсхолдер реквизитов оператора' ),
                    // 2026-05-14 (plan immutable-pondering-harbor): фиксация переработанных формулировок под РКН-рекомендации.
                    array( 'налог на профессиональный доход', 'Корректная формулировка статуса оператора-физлица (422-ФЗ), а не ошибочная ОПФ «Самозанятый»' ),
                    array( 'адрес для корреспонденции', 'Публичный адрес для физлица — «Адрес для корреспонденции» вместо «Юридический адрес»' ),
                    array( '7 (семи) рабочих дней', 'Сроки уточнения и уничтожения ПД при подтверждении неточности/незаконности (ч. 1 ст. 21 152-ФЗ)' ),
                    array( 'не предназначен для использования лицами', 'Раздел о несовершеннолетних (Сервис не для лиц <18, оператор не собирает данные несовершеннолетних намеренно)' ),
                    array( 'отказ от предоставления данных', 'Раздел о последствиях отказа от предоставления ПД (рекомендация РКН-аудита)' ),
                    array( 'отзыв согласия', 'Формализованный механизм отзыва любого выданного согласия' ),
                    // 2026-05-17 (plan adaptive-sparking-hinton): фиксация раздела
                    // о передаче обезличенных данных ООО «Яндекс» (Метрика+Вебвизор).
                    array( 'яндекс.метрика', 'Раздел 9: передача обезличенных данных поставщику веб-аналитики (Яндекс.Метрика)' ),
                    array( 'вебвизор', 'Раздел 9: упоминание Вебвизора и маскирования ПДн в записях сессий' ),
                ),
                array(
                    'денежное вознаграждение',
                    // 2026-05-14: запрет регрессии на старые/некорректные формулировки.
                    'самозанятый',
                    'юридический адрес',
                    'aes-256-gcm',
                    '115-фз',
            ...
            'cookies_policy' => array(
                ...
                array(
                    ...
                    array( 'вебвизор', '2026-05-17: Вебвизор как часть аналитической категории с маскированием ПДн' ),
                    array( '{{operator_full_name}}', 'Должен сохраняться плейсхолдер реквизитов оператора' ),
                ),
                array(
                    'денежное вознаграждение',
            ...
            'tech_data' => array(
                ...
                array(
                    ...
                    array( 'вебвизор', '2026-05-17: Вебвизор как источник обезличенных поведенческих данных с маскированием ПДн' ),
                    array( '{{operator_full_name}}', 'Должен сохраняться плейсхолдер реквизитов оператора' ),
                ),
                array(
                    'денежное вознаграждение',
