    ...
    public static function create_tables(): void {
        ...
        $wpdb->query(
            "CREATE TABLE IF NOT EXISTS `{$prefix}cashback_affiliate_profiles` (
                ...
                `referral_click_id` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'Click ID при регистрации',
        ...
        $wpdb->query(
            "CREATE TABLE IF NOT EXISTS `{$prefix}cashback_affiliate_clicks` (
                ...
                `click_id` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT 'UUIDv7 (32 hex)',
    ...
    public static function ensure_audit_table(): void {
        ...
        $wpdb->query(
            "CREATE TABLE IF NOT EXISTS `{$prefix}cashback_affiliate_audit` (
                ...
                `click_id` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
                `partner_token_hash` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
                `ip_hash` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
                `ip_subnet_hash` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
                `ua_hash` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
                `key_hash` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
